...
save_massobj <-
  function(polarity, file_path, stage, obj) {
    if (stage == "step1") {
      ...
      if (polarity == "positive") {
        object_pos_raw <- obj
        save(object_pos_raw,
             file = paste0(file_path, "step1/object_pos_raw.rda"))
      } else if (polarity == "negative") {
        object_neg_raw <- obj
        save(object_neg_raw,
             file = paste0(file_path, "step1/object_neg_raw.rda"))
      }
    }
    if (stage == "mv") {
      dir.create(
        path = paste0(file_path, "step1"),
        showWarnings = F,
        recursive = T
      )
      if (polarity == "positive") {
        object_pos_mv <- obj
        save(object_pos_mv,
             file = paste0(file_path, "step1/object_pos_mv.rda"))
      } else if (polarity == "negative") {
        object_neg_mv <- obj
        save(object_neg_mv,
             file = paste0(file_path, "step1/object_neg_mv.rda"))
      }
    }
    if (stage == "outlier") {
      dir.create(
      ...
      if (polarity == "positive") {
        ...
        save(object_pos_outlier,
             file = paste0(file_path, "step1/object_pos_outlier.rda"))
      } else if (polarity == "negative") {
        object_neg_outlier <- obj
        save(object_neg_outlier,
             file = paste0(file_path, "step1/object_neg_outlier.rda"))
      }
    }
    if (stage == "impute") {
      dir.create(
      ...
      if (polarity == "positive") {
        ...
        save(object_pos_impute,
             file = paste0(file_path, "step1/object_pos_impute.rda"))
      } else if (polarity == "negative") {
        object_neg_impute <- obj
        save(object_neg_impute,
             file = paste0(file_path, "step1/object_neg_impute.rda"))
      }
    }
    if (stage == "norm") {
      dir.create(
      ...
      if (polarity == "positive") {
        object_pos_norm <- obj
        save(object_pos_norm,
             file = paste0(file_path, "step1/object_pos_norm.rda"))
      } else if (polarity == "negative") {
        object_neg_norm <- obj
        save(object_neg_norm,
             file = paste0(file_path, "step1/object_neg_norm.rda"))
      }
    }
    if (stage == "anno") {
      dir.create(
      ...
      if (polarity == "positive") {
        object_pos_anno <- obj
        save(object_pos_anno,
             file = paste0(file_path, "step1/object_pos_anno.rda"))
      } else if (polarity == "negative") {
        object_neg_anno <- obj
        save(object_neg_anno,
             file = paste0(file_path, "step1/object_neg_anno.rda"))
      }
    }
    if (stage == "af") {
      dir.create(
      ...
      if (polarity == "positive") {
        object_pos_af <- obj
        save(object_pos_af,
             file = paste0(file_path, "step1/object_pos_af.rda"))
      } else if (polarity == "negative") {
        object_neg_af <- obj
        save(object_neg_af,
             file = paste0(file_path, "step1/object_neg_af.rda"))
      }
    }
  }
